 ...
 * @enum {string}
 */
export declare enum RuleTriggerKeyword {
...
export declare function RuleTriggerKeywordFromJSON(json: any): RuleTriggerKeyword;
export declare function RuleTriggerKeywordFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleTriggerKeyword;
export declare function RuleTriggerKeywordToJSON(value?: RuleTriggerKeyword | null): any;
