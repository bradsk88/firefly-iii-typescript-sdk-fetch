...
export declare function RuleTriggerStoreFromJSON(json: any): RuleTriggerStore;
export declare function RuleTriggerStoreFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleTriggerStore;
export declare function RuleTriggerStoreToJSON(value?: RuleTriggerStore | null): any;
