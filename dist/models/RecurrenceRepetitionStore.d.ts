...
export declare function RecurrenceRepetitionStoreFromJSON(json: any): RecurrenceRepetitionStore;
export declare function RecurrenceRepetitionStoreFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurrenceRepetitionStore;
export declare function RecurrenceRepetitionStoreToJSON(value?: RecurrenceRepetitionStore | null): any;
