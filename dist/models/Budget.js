...
exports.BudgetToJSON = exports.BudgetFromJSONTyped = exports.BudgetFromJSON = void 0;
...
function BudgetFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'spent': !(0, runtime_1.exists)(json, 'spent') ? undefined : (json['spent'].map(_1.BudgetSpentFromJSON)),
    };
}
