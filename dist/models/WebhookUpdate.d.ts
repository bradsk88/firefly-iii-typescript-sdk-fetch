 ...
 */
import { WebhookDelivery, WebhookResponse, WebhookTrigger } from './';
/**
 *
 * @export
...
export declare function WebhookUpdateFromJSON(json: any): WebhookUpdate;
export declare function WebhookUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookUpdate;
export declare function WebhookUpdateToJSON(value?: WebhookUpdate | null): any;
