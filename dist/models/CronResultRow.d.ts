...
export declare function CronResultRowFromJSON(json: any): CronResultRow;
export declare function CronResultRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): CronResultRow;
export declare function CronResultRowToJSON(value?: CronResultRow | null): any;
