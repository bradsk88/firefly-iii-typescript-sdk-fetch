...
exports.MetaToJSON = exports.MetaFromJSONTyped = exports.MetaFromJSON = void 0;
...
function MetaFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'pagination': !(0, runtime_1.exists)(json, 'pagination') ? undefined : (0, _1.MetaPaginationFromJSON)(json['pagination']),
    };
}
...
function MetaToJSON(value) {
    ...
    return {
        'pagination': (0, _1.MetaPaginationToJSON)(value.pagination),
    };
}
