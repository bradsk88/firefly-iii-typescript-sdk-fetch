...
export declare function TransactionLinkUpdateFromJSON(json: any): TransactionLinkUpdate;
export declare function TransactionLinkUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionLinkUpdate;
export declare function TransactionLinkUpdateToJSON(value?: TransactionLinkUpdate | null): any;
