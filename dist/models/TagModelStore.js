...
exports.TagModelStoreToJSON = exports.TagModelStoreFromJSONTyped = exports.TagModelStoreFromJSON = void 0;
const runtime_1 = require("../runtime");
function TagModelStoreFromJSON(json) {
    return TagModelStoreFromJSONTyped(json, false);
}
exports.TagModelStoreFromJSON = TagModelStoreFromJSON;
function TagModelStoreFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TagModelStoreFromJSONTyped = TagModelStoreFromJSONTyped;
function TagModelStoreToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TagModelStoreToJSON = TagModelStoreToJSON;
