...
export declare function RecurrenceRepetitionFromJSON(json: any): RecurrenceRepetition;
export declare function RecurrenceRepetitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurrenceRepetition;
export declare function RecurrenceRepetitionToJSON(value?: RecurrenceRepetition | null): any;
