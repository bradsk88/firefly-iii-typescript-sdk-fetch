...
export declare function InsightTotalEntryFromJSON(json: any): InsightTotalEntry;
export declare function InsightTotalEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): InsightTotalEntry;
export declare function InsightTotalEntryToJSON(value?: InsightTotalEntry | null): any;
