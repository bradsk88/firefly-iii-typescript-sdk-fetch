...
exports.AccountStoreToJSON = exports.AccountStoreFromJSONTyped = exports.AccountStoreFromJSON = void 0;
const runtime_1 = require("../runtime");
const _1 = require("./");
function AccountStoreFromJSON(json) {
    return AccountStoreFromJSONTyped(json, false);
}
exports.AccountStoreFromJSON = AccountStoreFromJSON;
function AccountStoreFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AccountStoreFromJSONTyped = AccountStoreFromJSONTyped;
function AccountStoreToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AccountStoreToJSON = AccountStoreToJSON;
