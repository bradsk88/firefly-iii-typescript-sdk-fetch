 ...
 * @enum {string}
 */
export declare enum RuleActionKeyword {
...
export declare function RuleActionKeywordFromJSON(json: any): RuleActionKeyword;
export declare function RuleActionKeywordFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleActionKeyword;
export declare function RuleActionKeywordToJSON(value?: RuleActionKeyword | null): any;
