 ...
 */
import { TransactionSplitUpdate } from './';
/**
 *
 * @export
...
export declare function TransactionUpdateFromJSON(json: any): TransactionUpdate;
export declare function TransactionUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionUpdate;
export declare function TransactionUpdateToJSON(value?: TransactionUpdate | null): any;
