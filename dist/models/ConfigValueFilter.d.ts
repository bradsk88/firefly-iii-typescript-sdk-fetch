 ...
 * @enum {string}
 */
export declare enum ConfigValueFilter {
...
export declare function ConfigValueFilterFromJSON(json: any): ConfigValueFilter;
export declare function ConfigValueFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigValueFilter;
export declare function ConfigValueFilterToJSON(value?: ConfigValueFilter | null): any;
