...
export declare function InsightTransferEntryFromJSON(json: any): InsightTransferEntry;
export declare function InsightTransferEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): InsightTransferEntry;
export declare function InsightTransferEntryToJSON(value?: InsightTransferEntry | null): any;
