...
export declare function RuleTriggerFromJSON(json: any): RuleTrigger;
export declare function RuleTriggerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleTrigger;
export declare function RuleTriggerToJSON(value?: RuleTrigger | null): any;
