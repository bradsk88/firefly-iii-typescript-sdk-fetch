...
class ChartsApi extends runtime.BaseAPI {
     ...
     */
    async getChartAccountOverviewRaw(requestParameters) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(models_1.ChartDataSetFromJSON));
    }
    /**
     * This endpoint returns the data required to generate a chart with basic asset account balance information.
     * Dashboard chart with asset account balance information.
     */
    async getChartAccountOverview(requestParameters) {
