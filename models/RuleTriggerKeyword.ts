...
export function RuleTriggerKeywordFromJSON(json: any): RuleTriggerKeyword {
    return RuleTriggerKeywordFromJSONTyped(json, false);
}

export function RuleTriggerKeywordFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleTriggerKeyword {
    return json as RuleTriggerKeyword;
}

export function RuleTriggerKeywordToJSON(value?: RuleTriggerKeyword | null): any {
    return value as any;
}
