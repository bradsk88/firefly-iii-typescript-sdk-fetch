...
export function ConfigValueFilterFromJSON(json: any): ConfigValueFilter {
    return ConfigValueFilterFromJSONTyped(json, false);
}

export function ConfigValueFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigValueFilter {
    return json as ConfigValueFilter;
}

export function ConfigValueFilterToJSON(value?: ConfigValueFilter | null): any {
    return value as any;
}
