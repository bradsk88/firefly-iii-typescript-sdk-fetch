...
export function RuleActionKeywordFromJSON(json: any): RuleActionKeyword {
    return RuleActionKeywordFromJSONTyped(json, false);
}

export function RuleActionKeywordFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleActionKeyword {
    return json as RuleActionKeyword;
}

export function RuleActionKeywordToJSON(value?: RuleActionKeyword | null): any {
    return value as any;
}
